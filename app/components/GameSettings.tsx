...
const GameSettings = ({}: Props) => {
  return (
    <div className="w-full max-w-xs md:max-w-xl md:h-5/6 mx-auto flex flex-col justify-center gap-6 border border-neutral-700 rounded-3xl p-4 md:p-8 animate-fadeIn">
